...
%    \freefootnote{Sources: \url{https://github.com/kolosovpetro/github-latex-template}}
    ...
    \input{sections/01_polynomials_p_1_example_for_m1_n6_with_table}

    \subsection{Polynomials Q(1,n,k)}
    \input{sections/02_polynomials_q_1_n_k}

    \subsection{Polynomials Q(1,n,k) example n = 6}
    \input{sections/02_polynomials_q_1_example_for_m1_n6_with_table}

    \subsection{Polynomials P(2,n,k)}
    \input{sections/03_polynomials_p_2_n_k}

    \subsection{Polynomials P(2,n,k) example n = 4}
    \input{sections/03_polynomials_p_2_example_for_m2_n4_with_table}

    \subsection{Polynomials Q(2,n,k)}
    \input{sections/04_polynomials_q_2_n_k}

    \subsection{Polynomials Q(2,n,k) example n = 4}
    \input{sections/04_polynomials_q_2_example_for_m2_n4_with_table}

    \subsection{Polynomials P(3,n,k)}
    \input{sections/05_polynomials_p_3_n_k}

    \subsection{Polynomials P(3,n,k) example n = 3}
    \input{sections/05_polynomials_p_3_example_for_m3_n3_with_table}

    \subsection{Polynomials Q(3,n,k)}
    \input{sections/06_polynomials_q_3_n_k}

    \subsection{Polynomials Q(3,n,k) example n = 3}
    \input{sections/06_polynomials_q_3_example_for_m3_n3_with_table}
