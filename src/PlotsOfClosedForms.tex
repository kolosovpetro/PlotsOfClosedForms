...
%    \freefootnote{Sources: \url{https://github.com/kolosovpetro/github-latex-template}}
    ...
    \subsection{Polynomials Q(1,n,k)}\label{sec:polynomialsq1nk}
    \input{sections/polynomials_q_1_n_k}

    \subsection{Polynomials P(1,n,k)}\label{sec:polynomialsp1nk}
    \input{sections/polynomials_p_1_n_k}
